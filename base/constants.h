...
const TCHAR* const kOmahaBrokerFileName        =
    _T("HouseOfLifeUpdateBroker.exe");
const TCHAR* const kOmahaOnDemandFileName      =
    _T("HouseOfLifeUpdateOnDemand.exe");
...
const TCHAR* const kCertificateSubjectName = _T("House of Life");
