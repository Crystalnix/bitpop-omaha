...
#endif
    EXPECT_STREQ(_T("holupdateres_am.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_ar.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_bg.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_bn.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_ca.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_cs.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_da.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_de.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_el.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_en-GB.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_en.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_es-419.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_es.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_et.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_fa.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_fi.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_fil.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_fr.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_gu.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_hi.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_hr.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_hu.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_id.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_is.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_it.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_iw.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_ja.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_kn.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_ko.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_lt.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_lv.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_ml.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_mr.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_ms.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_nl.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_no.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_pl.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_pt-BR.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_pt-PT.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_ro.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_ru.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_sk.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_sl.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_sr.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_sv.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_sw.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_ta.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_te.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_th.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_tr.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_uk.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_ur.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_vi.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_zh-CN.dll"), files[file_index++]);
    EXPECT_STREQ(_T("holupdateres_zh-TW.dll"), files[file_index++]);
