...
const TCHAR kFullMachineOmahaMainKeyPath[] =
    _T("HKLM\\Software\\HouseOfLife\\BitpopUpdate\\");
const TCHAR kFullUserOmahaMainKeyPath[] =
    _T("HKCU\\Software\\HouseOfLife\\BitpopUpdate\\");
const TCHAR kFullMachineOmahaClientKeyPath[] =
    _T("HKLM\\Software\\HouseOfLife\\BitpopUpdate\\Clients\\")
    _T("{32E4419B-847F-4870-8640-073EF02C1890}");
const TCHAR kFullUserOmahaClientKeyPath[] =
    _T("HKCU\\Software\\HouseOfLife\\BitpopUpdate\\Clients\\")
    _T("{32E4419B-847F-4870-8640-073EF02C1890}");
...
const TCHAR kRegistryHiveOverrideRoot[] =
    _T("HKCU\\Software\\HouseOfLife\\BitpopUpdate\\UnitTest\\");
